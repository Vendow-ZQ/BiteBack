...
export const mockAssets: Record<string, MockAssetRef> = {
  ...
  'map-campus-route': {
    ...
    description: '从南科大地铁站 A 口到主推店的静态路线图；未接地图 API 前使用抽象线条占位'
  },
  'map-dessert-route': {
    id: 'map-dessert-route',
    kind: 'map',
    placeholderColor: '#24505b',
    description: '饭后去甜品/饮品店的路线图占位'
  },
  'creator-avatar-food': {
  ...
  'cover-hotpot': {
    ...
    kind: 'cover',
    placeholderColor: '#4b332c',
    description: '铜锅涮原收藏视频封面占位。请把真实封面放到 public/assets/food/ 或 covers/ 后再补 path'
  },
  'cover-dessert': {
    id: 'cover-dessert',
    kind: 'cover',
    placeholderColor: '#72515c',
    description: '甜品/饮品原收藏视频封面占位。请把真实封面放到 public/assets/food/ 或 covers/ 后再补 path'
  },
  'cover-campus': {
    id: 'cover-campus',
    kind: 'cover',
    placeholderColor: '#6b5f39',
    description: '校园炒饭原收藏视频封面占位。请把真实封面放到 public/assets/food/ 或 covers/ 后再补 path'
  }
};
